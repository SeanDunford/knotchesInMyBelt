function doStuff()
	{ 
		$.ajax({
		url: "http://127.0.0.1:8080/?proxy="+encodeURIComponent("http://dev.knotch.it:8080/miniProject/user_feed/500e3b57bbcd08696800000a/1000"),
...
function generateKnotch(title, opinion, pictureUrl, name){
